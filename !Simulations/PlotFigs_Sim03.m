...
text(5.5,9,txt1,'Color','r','FontSize',FS,'HorizontalAlignment','left');
...
legend('Planar,P=12mW','Planar,P=10mW','Planar,P=8mW','Cuboidal,P=12mW','Cuboidal,P=10mW','Cuboidal,P=8mW');
grid on
xlabel('Kr');
