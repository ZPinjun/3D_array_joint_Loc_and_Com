...
figure(1)
subplot(2,1,1)
semilogx(Kr_test, data_planar_peb(1,:),'bo-'); hold on
semilogx(Kr_test, data_cuboidal_peb(1,:),'rs-'); hold off
title('PEB vs. Kr');
xlabel('Kr');
ylabel('PEB');
...
subplot(2,1,2)
semilogx(Kr_test, data_planar_oeb(1,:),'bo-'); hold on
semilogx(Kr_test, data_cuboidal_oeb(1,:),'rs-'); hold off
title('OEB vs. Kr');
xlabel('Kr');
ylabel('OEB');
legend('Planar','Cuboidal')
