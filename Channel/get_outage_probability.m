function Pout = get_outage_probability(sp,cp,threshold,m,k,method)
...
if method == "analytical"
    ...
    for n = 1:N
        if visi_mat(m,n) == 1
            ...
            threshold_new = sqrt( threshold*sigman^2*norm(wsn,2)^2/P );
...
elseif method == "empirical"
    ...
    for i = 1:repeatNum
        ...
        for n = 1:N
            ...
            SNR(n,i) = P * abs(wsn.'*H_k_mn*wbm)^2 / (sigman^2*norm(wsn,2)^2);
        end
    end
